...
%
\begin{itemize}
\item Being able to predict the defect probability of each component in a given software project, that uses Git, with an useful precision, regardless of the programming language used.
