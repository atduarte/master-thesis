...
In order to facilitate using this method, the model is usually inferred by using the \emph{software} itself, specifically, by using the test cases defined in it \cite{Perez2004}.
